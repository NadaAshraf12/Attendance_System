        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActivationCode = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ForgetPasswordCode = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ...
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    AdditionalNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    RefreshToken = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RefreshTokenExpiryTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RoleHint = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JwtId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vacation_Users_SubstituteId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, "Regular user", "User", "USER", 0 },
                    { new Guid("22222222-2222-2222-2222-222222222222"), null, "Administrator", "Admin", "ADMIN", 1 },
                    { new Guid("33333333-3333-3333-3333-333333333333"), null, "Manager", "Manager", "MANAGER", 2 }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Department_Users_ManagerId1",
                table: "Department",
                column: "ManagerId1",
                principalTable: "Users",
                principalColumn: "Id");
